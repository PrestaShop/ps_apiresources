...
class TaxRuleEndpointTest extends ApiTestCase
{
    ...
    {
        // The grid query has no filtering mechanism at all before 9.2 (only the mandatory group filter
        // exists), so none of these filters are recognized on older Core: they're silently ignored
