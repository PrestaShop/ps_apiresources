...
class ThemeEndpointTest extends ApiTestCase
{
    ...
    {
        $themeName = get_env('PS_VERSION') ? 'classic' : 'hummingbird';
    ...
    {
        $themeNameCurrent = get_env('PS_VERSION') ? 'classic' : 'hummingbird';
        $themeNameEnable = get_env('PS_VERSION') ? 'hummingbird' : 'classic';
