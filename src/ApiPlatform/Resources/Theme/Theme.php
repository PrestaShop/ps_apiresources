...
#[ApiResource(
    operations: [
        new CQRSDelete(
            ...
            output: false,
            extraProperties: [
                // The Theme domain's CQRS commands only accept their ValueObject directly in their
                // constructor, which the generic CQRSApiNormalizer cannot build before this core fix.
                'minVersion' => '9.2.0',
            ],
