...
#[ApiResource(
    ...
    exceptionToStatus: [
        ...
        DeleteManufacturerException::class => Response::HTTP_INTERNAL_SERVER_ERROR,
        ManufacturerException::class => Response::HTTP_INTERNAL_SERVER_ERROR,
    ],
)]

class BulkManufacturers
{
    /**
     * @var int[]
     */
