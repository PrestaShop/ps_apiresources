...
class BulkDeleteExtraProperties
{
    /**
     * @var int[]
     */
    ...
    #[Assert\NotBlank]
    public array $extraPropertyIds;

    /**
     * When true, the physical column in the {entity}_extra storage table is also dropped.
     */
    public bool $dropColumn = false;

    public const COMMAND_MAPPING = [
        '[extraPropertyIds]' => '[ids]',
    ];
}
