...
#[ApiResource(
    operations: [
        new CQRSDelete(
            uriTemplate: '/products/{productId}/combinations/bulk-delete',
    ...
    exceptionToStatus: [
        ...
        CannotBulkDeleteCombinationException::class => Response::HTTP_UNPROCESSABLE_ENTITY,
        CombinationConstraintException::class => Response::HTTP_UNPROCESSABLE_ENTITY,
    ],
)]
class BulkProductCombinations
{
